  ...
  travelPlan: [
    {
      ...
      route: 'DFW → CLT → MYR',
      beforeYouLeave: [
        { id: 'tl-out-bags', text: 'All bags by the door: 2 checked + 3 personal + car seat in its bag (AirTag on); small stroller stays in the back of the vehicle' },
      ...
      runOfShow: [
        ...
        { time: '~7:40 AM', title: 'Arrive DFW — Terminal A', detail: 'Drop Morgan + Tatum + bags curbside (departures). Unclip the car seat and bag it; pull the small stroller out of the back of the car for Tatum and the bags.' },
        ...
        { time: '9:10 AM', title: 'Board (Group 5)', detail: 'Seats 35A / 35B, Tatum as a lap infant. Gate-check the stroller at the jet bridge on the way on.' },
        ...
        { time: '~4:32 PM', title: 'Land at MYR', detail: 'Grab the gate-checked stroller at the jet bridge, then collect the checked car seat + bags. Morgan’s family picks you up and drives to the condo (self check-in from 4 PM).' },
      ],
      carrying: [
        'Morgan: diaper bag + purse',
        'Toni: backpack (laptop, blankets) + wallet',
        'Small stroller — roll it through security, gate-check it at the jet bridge',
        'Checked: 2 bags + the car seat (in its bag)',
      ],
      note: 'The small travel stroller comes with us: pull it from the back of the vehicle at DFW, use it through the airport, and gate-check it at boarding. Family picks you up at MYR, so no rental car needed.',
    },
    {
      id: 'return',
      label: 'Return',
      ...
      route: 'MYR → DFW',
      beforeYouLeave: [
        { id: 'tl-ret-repack', text: 'Jul 6 night: repack everything; travel clothes laid out; pre-pack breakfast + snacks; stroller folded and ready to roll' },
      ...
      runOfShow: [
        ...
        { time: '5:33 AM', title: 'AA 4024 · MYR → DFW', detail: 'Gate-check the stroller at the jet bridge. Arrives DFW 8:45 AM. Cup/paci for the ears; she may sleep this early leg.' },
        { time: '~8:45 AM', title: 'Land at DFW', detail: 'Grab the gate-checked stroller at the jet bridge, then collect the car seat + bags. Your car is in the Terminal A garage — take the Skylink if you land at another terminal. Drive home.' },
      ],
      carrying: [
        'Morgan: diaper bag + purse',
        'Toni: backpack + wallet',
        'Small stroller — roll it through, gate-check it at the jet bridge',
        'Checked: 2 bags + the car seat',
      ],
      note: 'The stroller comes home with us too — gate-check it again on the way out. Family drops you at MYR, so no rental car.',
    },
  ],
